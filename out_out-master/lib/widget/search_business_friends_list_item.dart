...
class SearchBusinessFriendsListItem extends StatefulWidget{

  friendModel.Data data;
  String accessToken = '';
  String fromUserId = '';

  SearchBusinessFriendsListItem({
  ...
  @override
  _SearchBusinessFriendsListItemState createState() => _SearchBusinessFriendsListItemState();
}

class _SearchBusinessFriendsListItemState extends State<SearchBusinessFriendsListItem> {
