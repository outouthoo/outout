...
class OrderUserDetailScreen extends StatefulWidget {
  OrderUserDetailScreen(this.item);

  OrderUserItem item;

  @override
  OrderUserDetailScreenState createState() => OrderUserDetailScreenState();
}

class OrderUserDetailScreenState extends State<OrderUserDetailScreen> {
  @override
