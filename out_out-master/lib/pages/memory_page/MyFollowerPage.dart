...
class MyFollowerPageList extends StatefulWidget {
  @override
  MyFollowerPageListState createState() => MyFollowerPageListState();
}

class MyFollowerPageListState extends State<MyFollowerPageList> {
  User user;
  ...
  void getMyFriendList() async {
    ...
    ApiImplementer.getMyFollowerList(
  ...
  void callFollowApi(String userId, String id, String status) {
