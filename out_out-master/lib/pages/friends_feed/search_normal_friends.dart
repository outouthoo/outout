...
class SearchNormalFriends extends StatefulWidget {
  @override
  _SearchNormalFriendsState createState() => _SearchNormalFriendsState();
}

class _SearchNormalFriendsState extends State<SearchNormalFriends> {
