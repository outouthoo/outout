...
import 'package:out_out/pages/friends_feed/search_normal_friends.dart';
...
class NormalFriends extends StatefulWidget {
  @override
  _NormalFriendsState createState() => _NormalFriendsState();
}

class _NormalFriendsState extends State<NormalFriends> {
  ...
  Future _fetchPage(int pageKey) async {
    ...
    await ApiImplementer.ListbusinessAccountsApiImplementer(
            accessToken: user.accessToken, user_id: user.userId, type: 0)
        .then((value) {
