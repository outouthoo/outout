...
class CreatePublicEventPage extends StatefulWidget {
  const CreatePublicEventPage({Key key}) : super(key: key);

  @override
  _CreatePublicEventPageState createState() => _CreatePublicEventPageState();
}

class _CreatePublicEventPageState extends State<CreatePublicEventPage> {
